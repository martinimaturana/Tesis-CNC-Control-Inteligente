...
![Diagrama Eléctrico](../Imagenes/TABLERO_CNC.png)
![Texto alternativo (para accesibilidad)](hardware/Imagenes/tablero_cnc_real.jpeg)
![Texto alternativo (para accesibilidad)](hardware/Imagenes/TABLERO_CNC.png)
